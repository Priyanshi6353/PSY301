...
expName = 'PRIYANSHI.AU2220101_PRIMING'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\PRIYANSHI\\OneDrive\\Documents\\Priyanshi_AU2220101_PRIMING\\PRIYANSHI.AU2220101_PRIMING_lastrun.py',
